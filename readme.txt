...
* Fix: connections made before 1.6.8 can be recovered the same way: enable New connections on the Connection tab, click Reconnect in the app, and approve it. Nothing has to be removed or re-added. Existing connections and tokens are untouched.
